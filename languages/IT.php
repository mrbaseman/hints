...
/**
 *    Descrizione module Italiano
 *
 */
$module_description = 'Questo modulo ti permette di aggiungere commenti nel backend per documentazione, tutorial, ecc. - utile se hai autori meno esperti che hanno bisogno di alcuni suggerimenti su come utilizzare il backend o se una squadra ha bisogno di posti per mettere suggerimenti per gli altri membri del team';
...
$MOD_HINTS = array (
    ...
    'BOTTOM'      => "footer",
    'SHOW'        => "mostra nota",
    'TEXT_MODE'   => "modalit&agrave; display",
